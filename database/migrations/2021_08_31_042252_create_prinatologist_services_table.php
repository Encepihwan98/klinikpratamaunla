...
class CreatePrinatologistServicesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('prinatologist_services', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('prinatologist_services');
    }
}
