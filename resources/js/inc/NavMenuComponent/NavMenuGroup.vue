...
.app-navigation-menu {
  ...
  @include theme(v-list-group__header) using ($material-light) {
    &.v-list-item--active {
      background-color: rgba(map-deep-get($material-light, 'text', 'primary'), map-deep-get($material-light, 'states', 'selected'));
    }
  }
