    ...
    <v-main>
      <div class="app-content-container boxed-container pa-6">
        <v-card class="mx-auto" max-width="97%" elevation="5">
          <v-card-text>
            <p class="text-h6 text--primary">Daftar Kategori Kualifikasi</p>
          </v-card-text>
          <v-container>
            <v-row>
              ...
              >
                <v-container>
                  <v-row>
                    ...
                    <v-col class="d-flex" cols="12" sm="6">
                      <v-switch
                        v-model="agama.switch1"
                        :label="`Tenaga Medis: ${switch1.toString()}`"
                      ></v-switch>
                    </v-col>
                  </v-row>
                </v-container>
...
export default {
  ...
  created() {
    ...
    this._url = window.location.origin + "/api/v1/kategori-kualifikasi/";
    this.filterPage("");
  },
  computed: {
    dialogState() {
