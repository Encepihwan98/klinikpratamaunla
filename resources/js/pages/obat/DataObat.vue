                            ...
                            <v-container>
                                <v-row>
                                     <v-col class="pa-0" cols="12" sm="12">
                                        <v-text-field label="Nama Obat"  outlined dense small>
                                        </v-text-field>
                                    </v-col>
                                    <v-col class="pa-0" cols="12" sm="12">
                                        <v-textarea label="Kandungan" auto-grow outlined rows="1" row-height="15">
                                        </v-textarea>
                                    </v-col>
                                    <v-col class="pa-0 mr-2" cols="12" sm="7">
                                        <v-select :items="['Sakit Kepala', 'Sakit Perut']" label="Kategori Obat" dense outlined></v-select>
                                    </v-col>
                                    <v-col class="pa-0" cols="12" sm="4">
                                        <v-text-field label="Stock"  outlined dense small>
                                        </v-text-field>
                                    </v-col>
                                    <v-col class="pa-0" cols="12" sm="12">
                                        <v-text-field label="Harga"  outlined dense small>
                                        </v-text-field>
                                    </v-col>
                                    <v-col cols="12" sm="12">
