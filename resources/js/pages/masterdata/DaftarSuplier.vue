                ...
                <v-container>
                    <v-row>
                        <v-col cols="12" sm="12">
                            <v-card>
                                <v-card-text>
                                    <p class="text-h6"> Daftar Suplier</p>
                                </v-card-text>
                                <v-row>
                            ...
                            <v-container>
                                <v-row>
                                    <v-col class="pa-0 mr-6" cols="12" sm="12">
                                        <v-text-field label="Suplier" outlined dense v-model="suplier.nama"
                                            small>
                                        </v-text-field>
                                    </v-col>
                                    <v-col class="pa-0 mr-6" cols="12" sm="12">
                                        <v-text-field label="No Hp" outlined dense v-model="suplier.no_hp" small>
                                        </v-text-field>
                                    </v-col>
                                    <v-col class="pa-0 mr-6" cols="12" sm="12">
                                        <v-text-field label="Email" outlined dense v-model="suplier.email" small>
                                        </v-text-field>
                                    </v-col>
                                    <v-col class="pa-0 mr-6" cols="12" sm="12">
                                        <v-text-field label="Alamat" outlined dense v-model="suplier.alamat" small>
                                        </v-text-field>
                                    </v-col>
                                    <v-col cols="12" sm="12">
...
export default {
    ...
    methods: {
        ...
        store() {
            let req = Object.assign(this.suplier, this.filter);
            this.currentData = null;
            axios
                .post(this._url, req)
                .then((response) => {
        ...
        update() {
            let req = Object.assign(this.suplier, this.filter);
            axios
                .put(`${this._url}${this.suplier.id}`, req)
                .then((response) => {
                    if (response.status == 200) {
    ...
    created() {
        ...
        this._url = window.location.origin + "/api/v1/daftar-suplier/";
        this.filterPage("");
