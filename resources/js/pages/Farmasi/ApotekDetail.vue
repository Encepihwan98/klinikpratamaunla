<template>
  <v-app>
    ...
    <v-main>
        ...
        >
            <v-expansion-panel>
                <v-expansion-panel-header>Apotek Pasien Perawatan</v-expansion-panel-header>
...
import Alkes from '../../components/farmasi/Alkes.vue';

export default {
  components: { Diagnosa, Tindakan, Resep, Alkes },
  setup() {
