    ...
    <v-main>
      <div class="app-content-container boxed-container pa-6">
        <v-card class="mx-auto" max-width="97%" elevation="5">
          <v-card-text>
            <p class="text-h6 text--primary">Daftar Suplier</p>
          </v-card-text>
          <v-container>
            <v-row>
            ...
            <template v-slot:default>
              <thead>
                <tr>
                  ...
                  <th class="text-left">
                    Alamat
                    <v-icon @click="filterPage('address')" x-small>{{
                  ...
                  <th class="text-left">
                    no telp
                    <v-icon @click="filterPage('phone_number')" x-small>{{
                      filter.sortBy == "phone_number"
                        ? filter.orderBy == "asc"
                          ? "fas fa-sort-amount-up"
                          : "fas fa-sort-amount-down"
                        : "fas fa-sort-alt"
