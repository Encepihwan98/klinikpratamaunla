    ...
    <v-main>
      <div class="app-content-container boxed-container pa-6">
        <v-card class="mx-auto" max-width="97%" elevation="5">
          <v-card-text>
            <p class="text-h6 text--primary">Daftar Pemeriksaan Umum</p>
          </v-card-text>
          <v-container>
            <v-row>
            ...
            <template v-slot:default>
              <thead>
                <tr>
                  ...
                  <th class="text-left">
                    Periode
                    <v-icon @click="filterPage('period')" x-small>{{
                      filter.sortBy == "period"
                        ? filter.orderBy == "asc"
                          ? "fas fa-sort-amount-up"
                          : "fas fa-sort-amount-down"
                        : "fas fa-sort-alt"
...
export default {
  ...
  created() {
    ...
    this._url = window.location.origin + "/api/v1/daftar-pemeriksaan-umum/";
    this.filterPage("");
  },
  computed: {
    dialogState() {
