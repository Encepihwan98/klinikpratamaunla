    ...
    <v-main>
      <div class="app-content-container boxed-container pa-6">
        <v-card class="mx-auto" max-width="97%" elevation="5">
          <v-card-text>
            <p class="text-h6 text--primary">Daftar Registrasi</p>
          </v-card-text>
          <v-container>
            <v-row>
              ...
              >
                <v-container>
                  <v-row>
                    ...
                    <v-col class="d-flex" cols="12" sm="12">
                      <v-select
                        :items="['Pasien Baru','Rawat jalan', 'Rawat Inap','Gawat Darurat']"
                        label="Kategori Registrasi"
                        v-model="agama.category"
                        outlined
                        dense
                        clearable
                        :error-messages="errors.name"
...
export default {
  ...
  created() {
    ...
    this._url = window.location.origin + "/api/v1/daftar-registrasi/";
    this.filterPage("");
  },
  computed: {
    dialogState() {
