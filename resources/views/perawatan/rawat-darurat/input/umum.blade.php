<div class="container">
    ...
    <div class="row mt-4">
        ...
        <div class="col-lg-3 col-sm-3">
            <button class="btn btn-primary btn-sm right" data-toggle="modal" data-target="#umumModal">Tambah Data</button>
        </div>
    </div>
    <!-- end form -->
    ...
    <!-- modal -->
    <div class="modal fade" id="umumModal" tabindex="-1" role="dialog" aria-labelledby="umumModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="umumModalLabel">Pemeriksaan</h5>
                    ...
                    <form action="">
                        <div class="row">
                            <div class="form-group input-group-sm mb-12 col-lg-12">
                                <p class="dt">Jenis Pemeriksaan :</p>
                                <select class="form-control g_right" id="exampleFormControlSelect1">
                                    <option>10</option>
                                    <option>25</option>
                                    <option>50</option>
                            ...
                            <div class="form-group input-group-sm mb-12 col-lg-12">
                                <p class="dt">Haisl Pemeriksaan :</p>
