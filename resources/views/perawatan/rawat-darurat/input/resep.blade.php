<div class="container">
    ...
    <div class="row mt-4">
        ...
        <div class="col-lg-3 col-sm-3">
            <button class="btn btn-primary btn-sm right" data-toggle="modal" data-target="#resepModal">Tambah Data</button>
        </div>
    </div>
    <!-- end form -->
            ...
            <table class="table table-bordered table-hover table-striped table-checkable table-highlight-head mb-4">
                <thead>
                    <tr>
                        ...
                        <th class="">Obat <i class="fas fa-search"></i></th>
                        <th class="">Jumlah <i class="fas fa-search"></i></th>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="resepModalLabel">Diagnosa</h5>
                ...
                <div class="modal-body">
                    <form action="">
                        <div class="row">
                            ...
                            <div class="form-group input-group-sm mb-12 col-lg-12">
                                <p class="dt">Jumlah :</p>
                                <input type="text" class="form-control" placeholder="Jumlah" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                            </div>

                            <div class="form-group input-group-sm mb-12 col-lg-12">
                                <p class="dt">Aturan Pakai :</p>
                                <input type="text" class="form-control" placeholder="Aturan Pakai" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                            </div>
