<div class="container">
    ...
    <div class="row mt-4">
        ...
        <div class="col-lg-3 col-sm-3">
            <button class="btn btn-primary btn-sm right" data-toggle="modal" data-target="#tindakanModal">Tambah Data</button>
        </div>
    </div>
    <!-- end form -->
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover table-striped table-checkable table-highlight-head mb-4">
                <thead>
                    <tr>
                        <th>No</th>
                        <th class="">Waktu Pemeriksaaan <i class="fas fa-search"></i></th>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="tindakanModalLabel">Diagnosa</h5>
                    ...
                    <form action="">
                        <div class="row">
                            <div class="form-group input-group-sm mb-7 col-lg-7">
                                <p class="dt">Tindakan/Pemeriksaan :</p>
                                <select class="form-control g_right" id="exampleFormControlSelect1">
                                    <option>10</option>
                                    <option>25</option>
                                    <option>50</option>
