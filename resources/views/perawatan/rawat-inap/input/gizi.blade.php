<div class="container">
    ...
    <div class="row mt-4">
        ...
        <div class="col-lg-3 col-sm-3">
            <button class="btn btn-primary btn-sm right" data-toggle="modal" data-target="#giziModal">Tambah Data</button>
        </div>
    </div>
    <!-- end form -->
    ...
    <!-- modal -->
    <div class="modal fade" id="giziModal" tabindex="-1" role="dialog" aria-labelledby="giziModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="giziModalLabel">Gizi</h5>
