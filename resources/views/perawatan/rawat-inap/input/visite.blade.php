<div class="container">
    ...
    <div class="row mt-4">
        ...
        <div class="col-lg-3 col-sm-3">
            <button class="btn btn-primary btn-sm right" data-toggle="modal" data-target="#visiteModal">Tambah Data</button>
        </div>
    </div>
    <!-- end form -->
    ...
    <!-- modal -->
    <div class="modal fade" id="visiteModal" tabindex="-1" role="dialog" aria-labelledby="visiteModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="visiteModalLabel">Visite</h5>
