<div class="container">
    ...
    <div class="row mt-4">
        ...
        <div class="col-lg-3 col-sm-3">
            <button class="btn btn-primary btn-sm right" data-toggle="modal" data-target="#khususModal">Tambah Data</button>
        </div>
    </div>
    <!-- end form -->
    ...
    <!-- modal -->
    <div class="modal fade" id="khususModal" tabindex="-1" role="dialog" aria-labelledby="khususModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="khususModalLabel">Perawatan Khusus</h5>
