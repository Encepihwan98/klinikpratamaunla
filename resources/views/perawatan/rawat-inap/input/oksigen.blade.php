<div class="container">
    ...
    <div class="row mt-4">
        ...
        <div class="col-lg-3 col-sm-3">
            <button class="btn btn-primary btn-sm right" data-toggle="modal" data-target="#oksigenModal">Tambah Data</button>
        </div>
    </div>
    <!-- end form -->
    ...
    <!-- modal -->
    <div class="modal fade" id="oksigenModal" tabindex="-1" role="dialog" aria-labelledby="oksigenModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="oksigenModalLabel">Oksigen</h5>
                ...
                <div class="modal-body">
                    <form action="">
                        <div class="row">
                            <div class="form-group input-group-sm mb-7 col-lg-7">
                                <p>Pilih Oksigen</p>
                                <select class="form-control g_right" id="exampleFormControlSelect1">
                                    <option>10</option>
                                    <option>25</option>
                            ...
                            <div class="form-group input-group-sm mb-5 col-lg-5">
                                <p>Jumlah</p>
                                <input type="text" class="form-control" placeholder="Hasil Pemeriksaan" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                            </div>
