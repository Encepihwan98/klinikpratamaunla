<div class="container">
    ...
    <div class="row mt-4">
        ...
        <div class="col-lg-3 col-sm-3">
            <button class="btn btn-primary btn-sm right" data-toggle="modal" data-target="#tambahModal">Rujuk Kepasilitas Penunjang</button>
        </div>
    </div>
    <!-- end form -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="tambahModalLabel">Rujuk Ke Fasilitas Penunjang</h5>
