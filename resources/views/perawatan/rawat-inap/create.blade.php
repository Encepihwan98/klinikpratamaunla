                    ...
                    <div class="statbox widget box box-shadow">
                        ...
                        <div class="widget-content widget-content-area simple-tab">
                            <ul class="nav nav-tabs  mb-3 mt-3" id="simpletab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="tindakan-tab" data-toggle="tab" href="#tindakan" role="tab" aria-controls="contact" aria-selected="false">Tindakan</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="visite-tab" data-toggle="tab" href="#visite" role="tab" aria-controls="contact" aria-selected="false">Visite</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="visite-tab" data-toggle="tab" href="#khusus" role="tab" aria-controls="contact" aria-selected="false">Khusus</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="visite-tab" data-toggle="tab" href="#oksigen" role="tab" aria-controls="contact" aria-selected="false">Oksigen</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="visite-tab" data-toggle="tab" href="#gizi" role="tab" aria-controls="contact" aria-selected="false">Gizi</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="visite-tab" data-toggle="tab" href="#mutasi-kamar" role="tab" aria-controls="contact" aria-selected="false">Mutasi</a>
                                </li>
                            </ul>
                            <div class="tab-content" id="simpletabContent">
                                <div class="tab-pane fade " id="penunjang" role="tabpanel" aria-labelledby="home-tab">
                                   @include('perawatan.rawat-inap.input.penunjang')
                                </div>
                                <div class="tab-pane fade show active" id="diagnosa" role="tabpanel" aria-labelledby="diagnosa-tab">
                                    <p class="">
                                        @include('perawatan.rawat-inap.input.diagnosa')
                                    </p>
                                </div>
                                <div class="tab-pane fade" id="tindakan" role="tabpanel" aria-labelledby="tindakan-tab">
                                    <p class="">
                                        @include('perawatan.rawat-inap.input.tindakan')
                                    </p>
                                </div>
                                <div class="tab-pane fade" id="umum" role="tabpanel" aria-labelledby="umum-tab">
                                    <p class="">
                                        @include('perawatan.rawat-inap.input.umum')
                                    </p>
                                </div>
                                <div class="tab-pane fade" id="resep" role="tabpanel" aria-labelledby="resep-tab">
                                    <p class="">
                                        @include('perawatan.rawat-inap.input.resep')
                                    </p>
                                </div>
                                <div class="tab-pane fade" id="visite" role="tabpanel" aria-labelledby="resep-tab">
                                    <p class="">
                                        @include('perawatan.rawat-inap.input.visite')
                                    </p>
                                </div>
                                <div class="tab-pane fade" id="khusus" role="tabpanel" aria-labelledby="resep-tab">
                                    <p class="">
                                        @include('perawatan.rawat-inap.input.khusus')
                                    </p>
                                </div>
                                <div class="tab-pane fade" id="oksigen" role="tabpanel" aria-labelledby="resep-tab">
                                    <p class="">
                                        @include('perawatan.rawat-inap.input.oksigen')
                                    </p>
                                </div>
                                <div class="tab-pane fade" id="gizi" role="tabpanel3" aria-labelledby="resep-tab">
                                    <p class="">
                                        @include('perawatan.rawat-inap.input.gizi')
                                    </p>
                                </div>
                                <div class="tab-pane fade" id="mutasi-kamar" role="tabpanel3" aria-labelledby="resep-tab">
                                    <p class="">
                                        @include('perawatan.rawat-inap.input.mutasi-kamar')
                                    </p>
                                </div>
                            </div>
                        </div>
