...
<body>
    <center>
        ...
        <table width="100%">
			<tr class="text2">
				<center>
					<font size="5"><b>SURAT KETERANGAN SAKIT<b></font><br>
				</center>
			</tr>
		</table>
        <br>
        ...
        <table width="100%">
            <tr>
                <td>
                    <font size="2">Berdasarkan pemeriksaan fisik pada hari ini dalam keadaan sakit dan
                        perlu beristirahat selama {{$jumlah}} hari, terhitunga mulai tanggal {{$from}} s/d {{$to}}.<br>
