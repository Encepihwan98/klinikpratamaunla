...
class LogisticTypeController extends Controller
{
    ...
    {
        $data = LogisticType::where('id',$id)->first();
        return response()->json(['data' => $data,'message' => 'Successfully.', 'status'=>'success']);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        LogisticType::where('id', $id)->update([
    ...
    public function destroy(Request $request, $id)
    {
        ...
        LogisticType::where('id', $id)->delete();
    ...
    public function filter(Request $request) {
        ...
        $data = LogisticType::when(!empty($search), function ($query) use ($search) {
