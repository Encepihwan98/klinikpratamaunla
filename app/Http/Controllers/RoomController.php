...
class RoomController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        Room::where('id', $id)->update([
            'polyclinic_room_id' => $request->polyclinic_room_id,
            'name' => $request->name,
        ]);
    ...
    public function filter(Request $request) {
        ...
        $data = Room::when(!empty($search), function ($query) use ($search) {
    ...
    public function select_function(Request $request)
    {
        $select = $request->inPatientRoom_id;
        $data = Room::where('polyclinic_room_id',$select)->first();
        return response()->json(['data' => $data,'message' => 'Successfully.', 'status'=>'success']);
    }
}
