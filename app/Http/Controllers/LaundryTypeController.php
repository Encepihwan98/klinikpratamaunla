...
class LaundryTypeController extends Controller
{
    ...
    {
        $data = LaundryType::where('id',$id)->first();
        return response()->json(['data' => $data,'message' => 'Successfully.', 'status'=>'success']);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        LaundryType::where('id', $id)->update([
    ...
    public function destroy(Request $request, $id)
    {
        ...
        LaundryType::where('id', $id)->delete();
    ...
    public function filter(Request $request) {
        ...
        $data = LaundryType::when(!empty($search), function ($query) use ($search) {
