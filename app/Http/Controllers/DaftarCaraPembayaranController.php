...
use App\Models\DaftarCaraPembayaran;

use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;

class DaftarCaraPembayaranController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $store = new DaftarCaraPembayaran();
        // $store->id = Str::id();
    ...
    {
        $data = DaftarCaraPembayaran::where('id',$id)->first();
        return response()->json(['data' => $data,'message' => 'Successfully.', 'status'=>'success']);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        DaftarCaraPembayaran::where('id', $id)->update([
    ...
    public function destroy(Request $request, $id)
    {
        ...
        DaftarCaraPembayaran::where('id', $id)->delete();
    ...
    public function filter(Request $request) {
        ...
        $data = DaftarCaraPembayaran::when(!empty($search), function ($query) use ($search) {
