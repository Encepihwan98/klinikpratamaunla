...
class MInseneratorController extends Controller
{
    /**
    ...
    {
        $data = Incinerator::where('id',$id)->first();
        return response()->json(['data' => $data,'message' => 'Successfully.', 'status'=>'success']);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        Incinerator::where('id', $id)->update([
    ...
    public function destroy(Request $request, $id)
    {
        ...
        Incinerator::where('id', $id)->delete();
    ...
    public function filter(Request $request) {
        ...
        $data = Incinerator::when(!empty($search), function ($query) use ($search) {
