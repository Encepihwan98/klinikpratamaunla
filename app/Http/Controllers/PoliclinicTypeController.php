...
use App\Models\PoliclinicType;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;

class PoliclinicTypeController extends Controller
{
    ...
    {
        $data = PoliclinicType::where('id',$id)->first();
        return response()->json(['data' => $data,'message' => 'Successfully.', 'status'=>'success']);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        PoliclinicType::where('id', $id)->update([
    ...
    public function destroy(Request $request, $id)
    {
        ...
        PoliclinicType::where('id', $id)->delete();
    ...
    public function filter(Request $request) {
        ...
        $data = PoliclinicType::when(!empty($search), function ($query) use ($search) {
