...
class IdentityTypeController extends Controller
{
    ...
    {
        $data = IdentityType::where('id',$id)->first();
        return response()->json(['data' => $data,'message' => 'Successfully.', 'status'=>'success']);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        IdentityType::where('id', $id)->update([
    ...
    public function destroy(Request $request, $id)
    {
        ...
        IdentityType::where('id', $id)->delete();
    ...
    public function filter(Request $request) {
        ...
        $data = IdentityType::when(!empty($search), function ($query) use ($search) {
