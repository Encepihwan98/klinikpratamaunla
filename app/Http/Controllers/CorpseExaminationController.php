...
use App\Models\CorpseExamination;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;

class CorpseExaminationController extends Controller
{
    ...
    {
        $data = CorpseExamination::where('id',$id)->first();
        return response()->json(['data' => $data,'message' => 'Successfully.', 'status'=>'success']);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        CorpseExamination::where('id', $id)->update([
    ...
    public function destroy(Request $request, $id)
    {
        ...
        CorpseExamination::where('id', $id)->delete();
    ...
    public function filter(Request $request) {
        ...
        $data = CorpseExamination::when(!empty($search), function ($query) use ($search) {
