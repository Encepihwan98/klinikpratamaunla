...
use App\Models\MedicalActivityType;
...
class KategoriKegiatanController extends Controller
{
    ...
    {
        $data = MedicalActivityType::where('id',$id)->first();
        return response()->json(['data' => $data,'message' => 'Successfully.', 'status'=>'success']);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        MedicalActivityType::where('id', $id)->update([
    ...
    public function destroy(Request $request, $id)
    {
        ...
        MedicalActivityType::where('id', $id)->delete();
    ...
    public function filter(Request $request) {
        ...
        $data = MedicalActivityType::when(!empty($search), function ($query) use ($search) {
