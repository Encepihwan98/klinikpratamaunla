...
use App\Models\ExaminationAction;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;

class ExaminationActionController extends Controller
{
    /**
    ...
    {
        $data = ExaminationAction::where('id',$id)->first();
        return response()->json(['data' => $data,'message' => 'Successfully.', 'status'=>'success']);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        ExaminationAction::where('id', $id)->update([
    ...
    public function destroy(Request $request, $id)
    {
        ...
        ExaminationAction::where('id', $id)->delete();
    ...
    public function filter(Request $request) {
        ...
        $data = ExaminationAction::when(!empty($search), function ($query) use ($search) {
