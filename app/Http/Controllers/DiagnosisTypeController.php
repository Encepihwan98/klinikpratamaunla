...
class DiagnosisTypeController extends Controller
{
    ...
    {
        $data = DiagnosisType::where('id',$id)->first();
        return response()->json(['data' => $data,'message' => 'Successfully.', 'status'=>'success']);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        DiagnosisType::where('id', $id)->update([
    ...
    public function destroy(Request $request, $id)
    {
        ...
        DiagnosisType::where('id', $id)->delete();
    ...
    public function filter(Request $request) {
        ...
        $data = DiagnosisType::when(!empty($search), function ($query) use ($search) {
