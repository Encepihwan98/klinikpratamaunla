...
class UtdrsController extends Controller
{
    ...
    public function filter(Request $request) {
        ...
        $data = UTDRS::when(!empty($search), function ($query) use ($search) {
